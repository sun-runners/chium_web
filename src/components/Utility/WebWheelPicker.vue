...
.smooth-picker {
  ...
  .smooth-handle-layer {
    ...
    .smooth-top {
      ...
      background: linear-gradient(to bottom, white 1%, rgba(255, 255, 255, 0.1) 100%);
      transform: translate3d(0, 0, 2.625em);
      height: 70px;
    }
    ...
    .smooth-bottom {
      border-top: 1px solid #e1d0d0;
      background: linear-gradient(to top, white 5%, rgba(255, 255, 255, 0.1) 100%);
      transform: translate3d(0, 0, 2.625em);
      height: 70px;
    }
  }
