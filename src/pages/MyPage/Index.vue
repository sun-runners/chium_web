        ...
        <div class="bg-white">
            ...
            <div class="row items-center justify-evenly">
                <q-item-section class="review column items-center q-pa-lg">
                    <p class=" text-dark q-ma-none notosanskr-bold" style="font-size: 24px;">1</p>
                    <p class="text notosanskr-medium" style="font-size: 13px;">리뷰</p>
                </q-item-section>
                <q-separator color="grey-4" vertical inset  size="1px" />
                <q-item-section class="consult column items-center q-pa-lg">
                    <p class=" text-dark q-ma-none notosanskr-bold" style="font-size: 24px;">2</p>
                    <p class="text notosanskr-medium" style="font-size: 13px;">상담</p>
                </q-item-section>
            </div>
        </div>
        <div class="bg-white q-mt-md q-pa-none">
            <div class="row items-center justify-between">
                <div class="col-8 q-pa-lg">
                    ...
                    <p class="q-ma-none q-pt-sm notosanskr-regular" style="font-size: 16px; line-height: 24px;">경기도 화성시 정남면 괘랑4길 16-38</p>
                </div>
                <div class="q-pa-lg ">
                    <q-btn color="white" text-color="black" class="notosanskr-medium" outline label="수정" />
                </div>
            </div>
            ...
            <div class="row items-center justify-between">
                <div class="col-8 q-pa-lg">
                    ...
                    <p class="q-ma-none q-pt-sm notosanskr-bold" style="font-size: 16px; line-height: 24px;">010-2398-0374</p>
                </div>
                <div class="q-pa-lg ">
                    <q-btn color="white" class="notosanskr-medium" text-color="black"  outline label="수정"/>
                </div>
            </div>
            <q-separator size="1px" />
            <div class="q-pa-none q-pt-md q-mt-lg notosanskr-medium">
                <p style="font-size: 18px; line-height: 27px;" class=" q-pl-sm">최근 본 업체</p>
